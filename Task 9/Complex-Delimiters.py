...
inputString = input("""Enter a string containing one or more delimiter strings, each one enclosed by square brackets, 
and any number of positive integers each separated by a delimiter, following the format //[delimiter]\\n[numbers...]
