...
def Add(strIn):
    ...
    # 2nd: split input string at the commas and then at the newline
    partialStrInParts = strIn.split(",")
    strInParts = [part for partial in partialStrInParts for part in partial.split('\\n')]
    print(strInParts)
...
inputString = input("Enter any number of integers separated by a comma or a newline (\\n):\n")
sum = Add(inputString)
