...
def Add(strIn):
    ...
    for elem in strInParts:
        try:
            ...
            return 0
    # 6th: return the sum of the integers obtained from the input string
    return sum

# General execution of the program
inputString = input("""Enter a string containing a delimiter character, and any number of integers separated by the delimiter,
